...
controller.hears(['mvv'], ['direct_mention'], function(bot, message) {
　　　　bot.reply(message, 'githubはこれ \n https://github.com/nisimotoryoga/mvvex/edit/master/index.js \n\n 書き方はこのesaを参考にするとえーよ \n https://mf.esa.io/posts/93424');
　　});
